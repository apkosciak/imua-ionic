...
.controller 'ProfileController', ['$scope', 'user_with_contacts', 'UsersService', 'current_user', 'LoadingService',
($scope, user_with_contacts, UsersService, current_user, LoadingService) ->
