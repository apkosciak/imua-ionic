...
.controller 'RoadmapController', ['$scope', '$modal', '$stateParams', 'RoadmapService', 'LoadingService', 'OrganizationService', 'UsersService',
($scope, $modal, $stateParams, RoadmapService, LoadingService, OrganizationService, UsersService) ->
