...
.controller 'StudentsCtrl', ['$scope', '$modal', '$stateParams', 'current_user', 'UsersService', 'ProgressService', 'ExpectationService', 'OrganizationService'
  ($scope, $modal, $stateParams, current_user, UsersService, ProgressService, ExpectationService, OrganizationService) ->
    ...
    OrganizationService.getOrganizationWithUsers($stateParams.id)
      .success (data) ->
