...
.controller 'UserAssignmentController', ['$scope', '$stateParams', 'current_user', 'user_assignment', 'AssignmentService', 'UsersService', 'OrganizationService',
  ($scope, $stateParams, current_user, user_assignment, AssignmentService, UsersService, OrganizationService) ->
