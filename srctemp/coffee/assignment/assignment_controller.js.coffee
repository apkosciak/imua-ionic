...
.controller 'AssignmentController', ['$scope', '$stateParams', 'current_user', 'assignment', 'edit', 'AssignmentService', 'UsersService', 'OrganizationService',
  ($scope, $stateParams, current_user, assignment, edit, AssignmentService, UsersService, OrganizationService) ->
