...
.controller 'OutgoingAssignmentsController', ['$scope', '$stateParams', 'current_user', 'user', 'AssignmentService', 'UsersService', 'OrganizationService',
  ($scope, $stateParams, current_user, user, AssignmentService, UsersService, OrganizationService) ->
