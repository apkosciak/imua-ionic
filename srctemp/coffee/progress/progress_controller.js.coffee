...
.controller 'ProgressController', ['$state', '$scope', 'current_user', 'student', 'OrganizationService', 'ProgressService', 'ExpectationService', 'UsersService',
($state, $scope, current_user, student, OrganizationService, ProgressService, ExpectationService, UsersService) ->
