...
.controller 'StudentViewController', ['$stateParams', '$scope', 'current_user', 'student', 'OrganizationService', 'ProgressService', 'ExpectationService', 'UsersService',
($stateParams, $scope, current_user, student, OrganizationService, ProgressService, ExpectationService, UsersService) ->
