...
.controller 'ExpectationController', ['$scope', '$stateParams', 'current_user', 'expectation_id', 'ExpectationService', 'UsersService', 'OrganizationService', 'RoadmapService', 'ProgressService',
  ($scope, $stateParams, current_user, expectation_id, ExpectationService, UsersService, OrganizationService, RoadmapService, ProgressService) ->
