...
.controller 'SetupController', ['$scope', '$modal', '$stateParams', '$location', 'current_user', 'CONSTANTS', 'RoadmapService', 'OrganizationService', 'UsersService',
($scope, $modal, $stateParams, $location, current_user, CONSTANTS, RoadmapService, OrganizationService, UsersService) ->
